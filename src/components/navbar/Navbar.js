...
function Navbar() {
  ...
  return (
    <div>
      {/* medium screens */}
      <div className="md:flex justify-between items-center my-4 lg:mx-5 hidden ">
        <Logo />
      ...
      {/* small screens */}
      <div>
        <div className="flex justify-between md:hidden my-4 small-width relative">
          <Logo />
          <div
          ...
          {showNavbar && (
            <div className="bg-white h-screen w-[354px] absolute top-0 left-0 px-4 z-10 ml-[-2px]">
              <div
