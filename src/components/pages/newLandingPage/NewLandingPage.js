      ...
      <div className=" newLandingPage-wrapper flex flex-col items-center">
        ...
        <div className="startsHere flex items-start justify-between">
          ...
          <div>
            ...
            <div className="flex flex-col">
              <div className="btnsFlex flex items-center justify-between">
                <button className="btns px-5 rounded-lg">Sign In</button>
                <button className="btns px-5 rounded-lg">Sign Up</button>
              </div>
              <div>Two</div>
            </div>
          </div>
